FROM debian:stable-20240812-slim AS install
RUN set -eux; \
    export DEBIAN_FRONTEND=noninteractive; \
    apt update; \
    for P in ca-certificates curl gnupg python3 libgl1 ocl-icd-libopencl1; do \
...
HEALTHCHECK --interval=1m CMD \
    ...
    || boinccmd --get_tasks | egrep -q "EXECUTING" || exit 1
